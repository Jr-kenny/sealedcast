...
export const sealedCastRegistryAbi = parseAbi([
  ...
  'function requestAccessKey(uint256 castId, uint256 fid, address reader) returns (bytes32 resultHandle)',
  'function createSealedCast(bytes32 farcasterCastHash, string encryptedContentUri, string publicHint, bool requirementIsPublic, bytes32 encryptedContentKey, bytes contentKeyProof, bytes32[] encryptedAudienceWallets, bytes[] audienceProofs) returns (uint256 castId)',
