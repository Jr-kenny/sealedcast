    ...
    <div className='flex flex-col items-center gap-6'>
      <div className='flex flex-col gap-3 text-center'>
        ...
        <p className='text-light-secondary dark:text-dark-secondary'>
          These settings affect all the SealedCast accounts on this browser.
        </p>
      </div>
      <article
      ...
      >
        <div className='grid grid-cols-[auto,1fr] gap-3'>
          <UserAvatar src='/assets/twitter-avatar.jpg' alt='SealedCast' />
          <div>
            <div className='flex gap-1'>
              <UserName verified name='SealedCast' />
              <p className='text-light-secondary dark:text-dark-secondary'>
                @sealedcast
              </p>
            ...
            <p className='whitespace-pre-line break-words'>
              Public casts travel through Farcaster. A sealed cast keeps its
              plaintext private and reveals it only after its access policy is
              satisfied.
            </p>
          </div>
        </div>
