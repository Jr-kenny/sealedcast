...
function SealedCastIcon({ className }: IconProps): JSX.Element {
  return (
    <svg
      className={className}
      viewBox='0 0 24 24'
    ...
    >
      <path
        d='M12 2.75 19 5.8v5.1c0 4.7-2.82 8.55-7 10.35-4.18-1.8-7-5.65-7-10.35V5.8L12 2.75Z'
        fill='currentColor'
        opacity='.18'
      />
      <path
      ...
      />
      <path
        d='M10.2 10.4V9.15a1.8 1.8 0 0 1 3.6 0v1.25'
        stroke='currentColor'
        strokeWidth='1.55'
        strokeLinecap='round'
      />
